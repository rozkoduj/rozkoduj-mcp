...
Works immediately, no API key needed. Sign in for higher quotas and access to paid tools.
...
| `search_knowledge` | Hybrid search across Rozkoduj's extended knowledge base. Requires `mcp:knowledge:read` scope (sign in to a paid plan). |
