...
_mcp_kwargs: dict[str, Any] = {
    "instructions": (
        ...
        "rozkoduj.com): use 'list_strategies' to browse the catalog (ranked by "
        "the Rozkoduj Score) and 'strategy_details' to drill into one - returns "
        "name, description, family/variant, and best_run metrics (rozkoduj_score, "
        "cagr/APY, max_drawdown, win_rate, and the risk mode). "
